...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map1 = new UnfoldingMap(this, 50, 50, 350, 1500, provider);
		map2= new UnfoldingMap(this,450,50,200,300,provider);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(-22.9f, -43.2f));
	    map2.zoomAndPanTo(zoomLevel, new Location(54.7350813f,25.2160938f));
